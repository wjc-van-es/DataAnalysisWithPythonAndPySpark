...
# the code/Ch06/json_show_samples/data_samples/sv_episodes.json file with
# https://www.liquid-technologies.com/online-json-to-schema-converter
# and wrote into code/Ch06/json_show_samples/json_schemas/tvmaze_episodes_schema.json
# The content of code/Ch06/json_show_samples/data_samples/sv_episodes.json could be validated with the content of
# code/Ch06/json_show_samples/json_schemas/tvmaze_episodes_schema.json with
