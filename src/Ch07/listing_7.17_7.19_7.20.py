...
results = most_reliable_drive_for_capacity(failure_rate(merged_df), capacity_GB=11176.0, top_n=25)
results.show(truncate=False)
results.coalesce(1).write.mode("overwrite").csv("./most_reliable_drives_11176GB.csv", sep='|', header=True, quote=None)
